...
### Upload CSV from block explorer

A pre-filled download link for the relevant block explorer (Etherscan, BaseScan, etc.) is shown on the page.

1. Click the link to open the explorer
2. Download the CSV
3. Upload via drag-and-drop or "Choose File" (up to 3 files)
