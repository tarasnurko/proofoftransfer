export const erc20Abi = [
  ...
  {
    inputs: [
      { internalType: "address", name: "newLiquidityPool_", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "newValidCallerHash_", type: "bytes32" },
    ],
    name: "addValidCaller",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "liquidityPools",
    outputs: [
      { internalType: "address[]", name: "liquidityPools_", type: "address[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
